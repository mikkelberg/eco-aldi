...
def remove_annotations_for_removed_images(images, annotations):
...
def enforce_negative_sample_ratio_in_dir(target_ratio: int, src_dir, dest_dir):
    ...
    for index, filename in enumerate(files, start=1):
        ...
        balanced_anns = remove_annotations_for_removed_images(images=balanced_images, annotations=coco_data["annotations"])
