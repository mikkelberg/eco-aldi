...
def plot_and_save_class_distribution(class_distribution, filename="data-annotations/pitfall-cameras/info/statistics/grouped-categories/class_distribution.png"):
    """
